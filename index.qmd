...
> Να συγκρίνουμε τις θειαζίδες και τα διουρητικά παρόμοιας δράσης (ΤΗΖ) με τους αναστολείς του μετατρεπτικού ενζύμου της αγγειοτασίνης (ΑCE) σε ασθενείς με βεβαιωμένη υπέρταση σε σχέση με 12 αποτελέσματα ενδιαφέροντος.
...
- Διαφορετικά προγνωτσικά μοντέλα σε κάθε βάση δεδομένων
